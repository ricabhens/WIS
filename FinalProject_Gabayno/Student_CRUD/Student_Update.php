...
<html><head>
  ...
  <body data-new-gr-c-s-check-loaded="14.1086.0" data-gr-ext-installed="">
    ...
    <form id="update_student" class="input-group" action="Students.php" method="get">
        New Username: <input type="text" name="new_name"  id="new_name" class="input-field" placeholder="Username" required> <br>
        User ID: <input type="number" name="enter_id" id="enter_id" class="input-field" placeholder="Student ID" required> <br>
